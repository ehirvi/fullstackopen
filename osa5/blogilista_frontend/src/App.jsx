...
const App = () => {
  ...
  const handleBlogCreation = async (blog) => {
    try {
      ...
      showNotification(`A new blog ${savedBlog.title} by ${savedBlog.author} was created`, 'success')
    } catch (err) {
  ...
  const handleBlogDeletion = async (deletedBlog) => {
    try {
      ...
      showNotification(`Blog ${deletedBlog.title} by ${deletedBlog.author} was succesfully removed`, 'success')
    } catch (err) {
